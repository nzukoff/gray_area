...
const int b2 = 3;     // the number of the pushbutton pin
const int b3 = 4;     // the number of the pushbutton pin
const int b4 = 5;     // the number of the pushbutton pin
const int b5 = 6;     // the number of the pushbutton pin
const int a1 = 0;     // the number of the analog pot1
const int a2 = 1;     // the number of the analog pot2
...
int bs5 = 3;         // variable for reading the pushbutton status
int ar1 = 0;         // variable for reading the analog 1 val
int ar2 = 1;         // variable for reading the analog2 val
